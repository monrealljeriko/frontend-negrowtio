...
const Apply = () => {
  ...
  return (
    <View style={styles.apply}>
      <View style={styles.applyParent}>
        <Text style={[styles.apply1, styles.apply1FlexBox]}>Apply</Text>
        <Image
      ...
      <View style={[styles.rectangleParent, styles.groupChildLayout]}>
        ...
        <View style={[styles.rectangleGroup, styles.groupLayout]}>
          ...
          <Text style={[styles.wallet, styles.apply1FlexBox]}>Wallet</Text>
        </View>
        <Pressable
